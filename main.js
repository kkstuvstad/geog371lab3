...
//Add colors for control tower points
...
airports = L.geoJson.ajax("assets/airports.geojson",{
  ...
  //click for popup feature on airports with control tower
  onEachFeature: function(feature, layer) {
      layer.bindPopup(feature.properties.CNTL_TWR);
  },
  //determine if an airport contains a control tower
  pointToLayer: function (feature, latlng) {
      var id = 0;
      if (feature.properties.CNTL_TWR == "Y") {id = 0;} //orange
      else {id = 1;} //CNTL_TWR == 'N', purple
...
//state boundaries outlined on map
